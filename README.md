...
App 安装后会注册开机广播接收器。设备开机完成或应用被替换安装后，系统会启动 Android 前台服务 `ControlHttpService`，服务在后台监听 `9999` 端口，不会自动打开主界面。

注意：为了长期后台监听端口，Android 会显示一条“副屏控制服务运行中”的常驻通知。这是前台服务机制要求。

## HTTP 控制接口

后台控制服务会在安卓设备上监听 `9999` 端口，打开 App 页面时也会显示当前控制地址：
